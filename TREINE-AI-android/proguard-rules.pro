...
# Firebase (Authentication + Firestore) já traz as próprias regras de keep;
# guardamos o progresso como texto JSON, sem mapeamento por reflexão, então
# só silenciamos avisos de dependências internas do gRPC/Firestore.
